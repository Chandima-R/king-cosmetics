                        ...
                        return (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="flex w-full items-center justify-between gap-5 pz-5 py-3 text-left sm:px-6"
                                >

                                    <div className="flex items-center gap-4">
                                        <span className={`flex h-10 w-10 shrink-0 items-center justify-center text-sm rounded-full text-primary transition-all duration-300 ${isActive
                                            ? "bg-primary-soft"
                                            : "bg-primary-soft/50"
                                            }`}>
                                        ...
                                        <h3 className={`pt-1 text-sm font-semibold leading-6 transition-colors duration-300 ${isActive
                                            ? "text-primary"
                                            : "text-foreground"
                                            }`}>
                                ...
                                >
                                    <div className="overflow-hidden">
                                        <div className="border-t border-primary/10 mx-5 px-5 pb-6 pt-5 sm:px-6 sm:pl-[76px]">
